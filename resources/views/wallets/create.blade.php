...
<div class="max-w-lg mx-auto">
    <h2 class="text-2xl font-bold text-content mb-6">Thêm ví mới</h2>
    @include('partials.flash')
    <form action="{{ route('wallets.store') }}" method="POST" class="bg-surface shadow rounded-lg p-6 space-y-4">
        @csrf
